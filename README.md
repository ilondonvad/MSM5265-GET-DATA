...
Резисторы на линиях данных очень важны, иначе будут помехи и ложные данные
![Подключение к приборной панели](dashPins.jpg)
![Подключение к приборной панели](nano.jpg)
