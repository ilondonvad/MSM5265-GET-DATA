...
void loop() {
  if (millis() % 1000 ==  0 && odo < 999999 && dayOdo < 999) {  // Должна уменьшать помехи и неверные данные пробега, но все равно проскакивают ненуные данные
    Serial.print("ODO: ");
    Serial.print(odo);
    Serial.print("\t day ODO: ");
    Serial.println(dayOdo);
  }
}
